...
#ifndef DM_TFT_ILI9163C_h
#define DM_TFT_ILI9163C_h

#include "DmTftBase.h"

class DmTftIli9163c : public DmTftBase
{
public:
#if defined (DM_TOOLCHAIN_ARDUINO)
  DmTftIli9163c(uint8_t cs=A3, uint8_t dc=A5, uint8_t rst=A2);
#elif defined (DM_TOOLCHAIN_MBED)
  DmTftIli9163c(uint8_t cs=A3, uint8_t dc=A5, uint8_t rst=A2, uint8_t miso=D12, uint8_t mosi=D11, uint8_t clk=D13);
#endif
  virtual ~DmTftIli9163c();
  void init(void);
private:

...
#ifndef DM_TFT_RM68090_h
#define DM_TFT_RM68090_h

#include "DmTftBase.h"

class DmTftRm68090 : public DmTftBase
{
public:
  DmTftRm68090(uint8_t wr=A4, uint8_t cs=A3, uint8_t dc=A5, uint8_t rst=A2);
  virtual ~DmTftRm68090();
  void init(void);
private:

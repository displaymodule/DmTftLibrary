...
#ifndef DM_TFT_ILI9341V_h
#define DM_TFT_ILI9341V_h

#include "DmTftBase.h"

class DmTftIli9341v : public DmTftBase
{
public:
  DmTftIli9341v(uint8_t wr=A4, uint8_t cs=A3, uint8_t dc=A5, uint8_t rst=A2);
  virtual ~DmTftIli9341v();
  void init(void);
private:

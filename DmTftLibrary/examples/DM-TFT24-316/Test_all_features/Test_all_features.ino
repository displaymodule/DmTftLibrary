...
DmTouch dmTouch = DmTouch(DmTouch::DM_TFT24_316, DmTouch::Auto, false);
...
void setup() {
  tft.init();
  dmTouch.init();
  dmTouch.setCalibrationMatrix(calibration.getDefaultCalibrationData((int)DmTouch::DM_TFT24_316));
